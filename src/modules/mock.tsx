...
export const COMETS_MOCK: Comet[] = [
    {
        ...
        image_url: 'http://localhost:9002/comets/halley.jpg',
        k_x: '0.587',
        k_y: '0.349',
        k_z: '-0.124',
    },
    {
        ...
        image_url: 'http://localhost:9002/comets/hale-bopp.jpg',
        k_x: '0.714',
        k_y: '-0.412',
        k_z: '0.568',
    },
    {
        ...
        image_url: 'http://localhost:9002/comets/neowise.jpg',
        k_x: '-0.123',
        k_y: '0.456',
        k_z: '0.789',
    },
    {
        ...
        price: 80000,
        image_key: '67p.jpg',
        image_url: 'http://localhost:9002/comets/67p.jpg',
        k_x: '0.234',
        k_y: '0.567',
        k_z: '-0.345',
    },
